...
class TestGroupSecretVariables:
    def test__single_secret_variable(self, gitlab):
        gf = GitLabForm(
            config_string=config_single_secret_variable, project_or_group=GROUP_NAME
        )
        gf.main()
    ...
    def test__reset_single_secret_variable(self, gitlab):
        ...
        gf = GitLabForm(
            config_string=config_single_secret_variable2, project_or_group=GROUP_NAME
        )
        gf.main()
    ...
    def test__delete_secret_variable(self, gitlab):
        ...
        gf = GitLabForm(
            config_string=config_delete_secret_variable, project_or_group=GROUP_NAME
        )
        gf.main()
    ...
    def test__more_secret_variables(self, gitlab):
        gf = GitLabForm(
            config_string=config_more_secret_variables, project_or_group=GROUP_NAME
        )
        gf.main()
    ...
    def test__masked_secret_variables(self, gitlab):
        gf = GitLabForm(
            config_string=config_masked_secret_variables, project_or_group=GROUP_NAME
        )
        gf.main()
    ...
    def test__protected_secret_variables(self, gitlab):
        gf = GitLabForm(
            config_string=config_protected_secret_variables, project_or_group=GROUP_NAME
        )
        gf.main()
