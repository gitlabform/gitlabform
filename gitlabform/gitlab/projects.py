...
class GitLabProjects(GitLabCore):
    ...
    def put_project_push_rules(self, project_and_group_name, project_settings):
        # project_push_rules has to be like this:
        # {
        #     'setting1': value1,
        #     'setting2': value2,
        # }
        # ..as documented at: https://docs.gitlab.com/ee/api/projects.html#get-project-push-rules
        self._make_requests_to_api("projects/%s/push_rule", project_and_group_name, 'PUT', project_settings)
