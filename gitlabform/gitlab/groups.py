...
class GitLabGroups(GitLabCore):
    ...
    def get_group_settings(self, group):
        try:
            return self._make_requests_to_api("groups/%s", group)
        except NotFoundException:
            return dict()

    def put_group_settings(self, group, group_settings):
        ...
        self._make_requests_to_api("groups/%s", group, "PUT", group_settings)
