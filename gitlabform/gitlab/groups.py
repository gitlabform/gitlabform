...
class GitLabGroups(GitLabCore):
    ...
    def delete_group_secret_variable(self, group, secret_variable_key):
        self._make_requests_to_api("groups/%s/variables/%s", (group, secret_variable_key), method='DELETE', expected_codes=[204, 404])
    ...
    def get_group_secret_variable_object(self, group, secret_variable_key):
        return self._make_requests_to_api("groups/%s/variables/%s", (group, secret_variable_key))
    ...
    def delete_group_secret_variable(self, group, secret_variable):
        self._make_requests_to_api("groups/%s/variables/%s", (group, secret_variable), 'DELETE',
                                   expected_codes=[200, 202, 204, 404])
