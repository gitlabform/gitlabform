...
class ProjectProcessor(AbstractProcessor):
    ...
    def _process_configuration(self, project_and_group: str, configuration: dict):
        ...
        if configuration["project"].get("transfer_from") is not None:
            ...
            try:
                project_in_config: Project = self.gl.get_project_by_name(
                ...
                project_to_be_transferred: Project = self.gl.get_project_by_name(
        ...
        if configuration["project"].get("archive") is not None:
            project: Project = self.gl.get_project_by_name(project_path_with_namespace)
