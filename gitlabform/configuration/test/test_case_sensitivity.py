...
class TestCaseSensitivitySettings:
    def test__config_with_different_case_group(self):
    ...
    def test__config_with_different_case_project(self):
    ...
    def test__config_with_different_case_duplicate_groups(self):
        config_yaml = """
        projects_and_groups:
    ...
    def test__config_with_different_case_duplicate_projects(self):
        config_yaml = """
        projects_and_groups:
          GroupNameWithVaryingCase/projectwithvaryingcase:
            project_settings:
    ...
    def test__config_with_different_case_duplicate_skip_groups(self):
        config_yaml = """
        skip_groups:
          - groupnamewithvaryingcase
          - GROUPnameWITHvaryingCASE
    ...
    def test__config_with_different_case_duplicate_skip_projects(self):
        config_yaml = """
        skip_projects:
          - GroupNameWithVaryingCase/projectwithvaryingcase
          - GroupNameWithVaryingCase/ProjectWithVaryingCase
